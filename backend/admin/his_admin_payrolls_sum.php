                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title" style="font-family:'Poppins',sans-sarif;">Total Salary Paid to Customer</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                                        ...
                                        <div class="col-6">
                                            <div class="text-right">
                                                <?php
                                                    ...
                                                    $stmt->close();
                                                ?>
                                                <h3 class="text-dark mt-1">$<span data-plugin="counterup"><?php echo $total_salary;?></span></h3>
